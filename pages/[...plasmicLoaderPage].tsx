...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "nSLDEzYTH9ZFtLdL8Ss4BW" },
  
    "pricing": {name: "Pricing", projectId: "nSLDEzYTH9ZFtLdL8Ss4BW" },
  
    "features": {name: "Features", projectId: "nSLDEzYTH9ZFtLdL8Ss4BW" },
